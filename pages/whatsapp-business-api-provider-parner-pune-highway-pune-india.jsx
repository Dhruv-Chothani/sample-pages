...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Parner Pune Highway, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-parner-pune-highway-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Parner Pune Highway"
    const State = "Pune"
