...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Hindan Residential Area, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-hindan-residential-area-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Hindan Residential Area"
