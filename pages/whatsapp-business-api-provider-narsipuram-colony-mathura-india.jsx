...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Narsipuram Colony, Mathura, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-narsipuram-colony-mathura-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Narsipuram Colony"
    const State = "Mathura"
