...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Melrose Bypass road, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-melrose-bypass-road-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Melrose Bypass road"
    const State = "Aligarh"
