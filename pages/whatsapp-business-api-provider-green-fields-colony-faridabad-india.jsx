...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Green Fields Colony, Faridabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-green-fields-colony-faridabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Green Fields Colony"
