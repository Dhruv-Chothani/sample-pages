...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Hem Chand Compound, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-hem-chand-compound-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Hem Chand Compound"
    const State = "Aligarh"
