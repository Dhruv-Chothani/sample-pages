...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Murbad Karjat Road, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-murbad-karjat-road-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Murbad Karjat Road"
    const State = "Mumbai"
