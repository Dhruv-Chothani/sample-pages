...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Baner Pashan Link Road, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-baner-pashan-link-road-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Baner Pashan Link Road"
    const State = "Pune"
