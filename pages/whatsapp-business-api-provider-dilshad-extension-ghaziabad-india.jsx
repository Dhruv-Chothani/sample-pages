...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Dilshad Extension, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-dilshad-extension-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Dilshad Extension"
