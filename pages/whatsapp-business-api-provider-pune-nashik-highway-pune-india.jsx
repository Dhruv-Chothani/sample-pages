...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Pune-Nashik Highway, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-pune-nashik-highway-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Pune-Nashik Highway"
    const State = "Pune"
