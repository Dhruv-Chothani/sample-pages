...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Mathura-Hathras Road, Mathura, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-mathura-hathras-road-mathura-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Mathura-Hathras Road"
    const State = "Mathura"
