...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Safdarjung Development Area, New Delhi, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-safdarjung-development-area-new-delhi-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Safdarjung Development Area"
