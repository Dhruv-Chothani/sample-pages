...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ganga Canal Colony, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ganga-canal-colony-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ganga Canal Colony"
    const State = "Aligarh"
