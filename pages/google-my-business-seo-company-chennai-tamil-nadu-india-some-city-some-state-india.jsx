            ...
            <section style={styles.section}>
              <div style={styles.imageContainer}>
                <img 
                  ...
                  alt={`google my business seo company chennai tamil nadu india in ${fullLocation}`} 
                  style={styles.image} 
                />
...
export default function Page() {
  ...
  const slug = "google-my-business-seo-company-chennai-tamil-nadu-india-some-city-some-state-india";
  const Keyword = "google my business seo company chennai tamil nadu india";
