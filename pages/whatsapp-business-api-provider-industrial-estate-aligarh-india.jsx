...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Industrial Estate, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-industrial-estate-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Industrial Estate"
    const State = "Aligarh"
