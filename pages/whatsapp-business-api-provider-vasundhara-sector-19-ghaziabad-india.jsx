...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Vasundhara Sector-19, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-vasundhara-sector-19-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Vasundhara Sector-19"
