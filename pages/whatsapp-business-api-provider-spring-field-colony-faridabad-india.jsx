...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Spring Field Colony, Faridabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-spring-field-colony-faridabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Spring Field Colony"
