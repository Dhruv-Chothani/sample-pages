          ...
          <div style={styles.mainContent}>
            ...
            <section style={styles.section}>
              <div style={styles.imageContainer}>
                <img 
                  src="/placeholder.svg?height=400&width=800&query=local business in {fullLocation}" 
                  alt={`Digital Marketing Solutions in ${fullLocation}`} 
                  style={styles.image} 
                />
...
export default function Page() {
  ...
  const slug = "digital-marketing-solutions-pune-maharashtra-india";
  const Keyword = "Digital Marketing Solutions";
  const City = "Pune";
