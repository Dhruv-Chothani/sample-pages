...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Mumbai-Pune Expressway, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-mumbai-pune-expressway-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Mumbai-Pune Expressway"
    const State = "Pune"
