...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Kondhwa-Pisoli Road, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-kondhwa-pisoli-road-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Kondhwa-Pisoli Road"
    const State = "Pune"
