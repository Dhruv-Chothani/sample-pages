...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Kharadi Bypass Road, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-kharadi-bypass-road-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Kharadi Bypass Road"
    const State = "Pune"
