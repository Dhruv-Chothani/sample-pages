...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `New Palam Vihar Phase 2, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-new-palam-vihar-phase-2-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "New Palam Vihar Phase 2"
    const State = "Gurgaon"
