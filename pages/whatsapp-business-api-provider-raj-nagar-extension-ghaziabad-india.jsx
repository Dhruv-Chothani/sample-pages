...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Raj Nagar Extension, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-raj-nagar-extension-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Raj Nagar Extension"
