...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ins shivaji lonavale, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ins-shivaji-lonavale-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ins shivaji lonavale"
    const State = "Pune"
