...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Sanjay Gandhi Colony, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-sanjay-gandhi-colony-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Sanjay Gandhi Colony"
    const State = "Aligarh"
