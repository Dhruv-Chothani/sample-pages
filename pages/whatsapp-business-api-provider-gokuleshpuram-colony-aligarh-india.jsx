...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Gokuleshpuram Colony, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-gokuleshpuram-colony-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Gokuleshpuram Colony"
    const State = "Aligarh"
