...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Pune Railway Station, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-pune-railway-station-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Pune Railway Station"
    const State = "Pune"
