...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Vasai-Nallasopara Link Road, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-vasai-nallasopara-link-road-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Vasai-Nallasopara Link Road"
    const State = "Mumbai"
