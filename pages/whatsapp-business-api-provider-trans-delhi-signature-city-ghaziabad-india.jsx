...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Trans Delhi Signature City, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-trans-delhi-signature-city-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Trans Delhi Signature City"
