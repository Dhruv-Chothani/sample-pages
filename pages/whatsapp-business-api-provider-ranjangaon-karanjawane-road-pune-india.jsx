...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ranjangaon Karanjawane Road, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ranjangaon-karanjawane-road-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ranjangaon Karanjawane Road"
    const State = "Pune"
