...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Sikandrapur Cherat, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-sikandrapur-cherat-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Sikandrapur Cherat"
    const State = "Aligarh"
