...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ashok Nagar Colony, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ashok-nagar-colony-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ashok Nagar Colony"
    const State = "Aligarh"
