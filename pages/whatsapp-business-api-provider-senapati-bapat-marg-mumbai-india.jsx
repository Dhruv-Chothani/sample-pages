...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Senapati Bapat Marg, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-senapati-bapat-marg-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Senapati Bapat Marg"
    const State = "Mumbai"
