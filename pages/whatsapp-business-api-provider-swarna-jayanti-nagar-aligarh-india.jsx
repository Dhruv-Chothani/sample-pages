...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Swarna Jayanti Nagar, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-swarna-jayanti-nagar-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Swarna Jayanti Nagar"
    const State = "Aligarh"
