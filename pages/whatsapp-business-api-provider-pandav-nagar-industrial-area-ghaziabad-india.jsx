...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Pandav Nagar Industrial Area, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-pandav-nagar-industrial-area-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Pandav Nagar Industrial Area"
    const State = "Ghaziabad"
