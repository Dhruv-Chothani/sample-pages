...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Greater Kailash II, New Delhi, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-greater-kailash-ii-new-delhi-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Greater Kailash II"
