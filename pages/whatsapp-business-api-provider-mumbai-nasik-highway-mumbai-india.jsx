...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Mumbai - Nasik Highway, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-mumbai-nasik-highway-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Mumbai - Nasik Highway"
    const State = "Mumbai"
