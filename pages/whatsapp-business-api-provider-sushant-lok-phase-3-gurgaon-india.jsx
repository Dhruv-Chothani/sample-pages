...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Sushant Lok Phase 3, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-sushant-lok-phase-3-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Sushant Lok Phase 3"
    const State = "Gurgaon"
