...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Crossing Republik, Ghaziabad, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-crossing-republik-ghaziabad-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Crossing Republik"
