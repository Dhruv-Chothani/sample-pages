...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Aurangabad Bangar, Mathura, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-aurangabad-bangar-mathura-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Aurangabad Bangar"
    const State = "Mathura"
