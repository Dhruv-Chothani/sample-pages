...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Khan Abdul Gafar Road, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-khan-abdul-gafar-road-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Khan Abdul Gafar Road"
    const State = "Mumbai"
