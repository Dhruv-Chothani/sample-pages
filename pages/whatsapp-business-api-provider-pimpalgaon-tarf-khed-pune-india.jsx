...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Pimpalgaon Tarf Khed, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-pimpalgaon-tarf-khed-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Pimpalgaon Tarf Khed"
    const State = "Pune"
