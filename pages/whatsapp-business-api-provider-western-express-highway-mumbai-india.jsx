...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Western Express Highway, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-western-express-highway-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Western Express Highway"
    const State = "Mumbai"
