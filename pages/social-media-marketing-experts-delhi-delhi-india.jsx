            ...
            <section style={styles.section}>
              <div style={styles.imageContainer}>
                <img 
                  ...
                  alt={`Social Media Marketing Experts in ${fullLocation}`} 
                  style={styles.image} 
                />
...
export default function Page() {
  ...
  const slug = "social-media-marketing-experts-delhi-delhi-india";
  const Keyword = "Social Media Marketing Experts";
  const City = "Delhi";
  const State = "Delhi";
