...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Bandra Kurla Complex, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-bandra-kurla-complex-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Bandra Kurla Complex"
    const State = "Mumbai"
