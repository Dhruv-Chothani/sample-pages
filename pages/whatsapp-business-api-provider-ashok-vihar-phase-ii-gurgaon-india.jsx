...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ashok Vihar Phase II, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ashok-vihar-phase-ii-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ashok Vihar Phase II"
    const State = "Gurgaon"
