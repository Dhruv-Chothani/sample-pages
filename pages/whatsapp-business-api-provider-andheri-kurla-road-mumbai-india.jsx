...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Andheri-Kurla Road, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-andheri-kurla-road-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Andheri-Kurla Road"
    const State = "Mumbai"
