...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Noida-Greater Noida Link Rd, Noida, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-noida-greater-noida-link-rd-noida-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Noida-Greater Noida Link Rd"
    const State = "Noida"
