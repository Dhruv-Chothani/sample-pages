...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Bhamola Alam Bagh, Aligarh, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-bhamola-alam-bagh-aligarh-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Bhamola Alam Bagh"
    const State = "Aligarh"
