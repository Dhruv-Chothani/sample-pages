...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Ashok Vihar Phase 1, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-ashok-vihar-phase-1-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Ashok Vihar Phase 1"
    const State = "Gurgaon"
