...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Katraj Kondhwa Road, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-katraj-kondhwa-road-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Katraj Kondhwa Road"
    const State = "Pune"
