            ...
            <section style={styles.section}>
              <div style={styles.imageContainer}>
                <img 
                  ...
                  alt={`google my business seo company hyderabad telangana india in ${fullLocation}`} 
                  style={styles.image} 
                />
...
export default function Page() {
  ...
  const slug = "google-my-business-seo-company-hyderabad-telangana-india-some-city-some-state-india";
  const Keyword = "google my business seo company hyderabad telangana india";
