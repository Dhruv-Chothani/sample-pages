...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Mathura Cantonment, Mathura, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-mathura-cantonment-mathura-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Mathura Cantonment"
    const State = "Mathura"
