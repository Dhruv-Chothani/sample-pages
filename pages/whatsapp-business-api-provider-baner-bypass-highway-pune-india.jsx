...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Baner Bypass Highway, Pune, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-baner-bypass-highway-pune-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Baner Bypass Highway"
    const State = "Pune"
