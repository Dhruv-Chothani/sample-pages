...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Chandrapuri Colony, Mathura, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-chandrapuri-colony-mathura-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Chandrapuri Colony"
    const State = "Mathura"
