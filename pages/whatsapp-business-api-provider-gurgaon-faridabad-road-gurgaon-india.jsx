...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Gurgaon-Faridabad Road, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-gurgaon-faridabad-road-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Gurgaon-Faridabad Road"
    const State = "Gurgaon"
