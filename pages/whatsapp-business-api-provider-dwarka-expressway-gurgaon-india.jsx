...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Dwarka Expressway, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-dwarka-expressway-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Dwarka Expressway"
    const State = "Gurgaon"
