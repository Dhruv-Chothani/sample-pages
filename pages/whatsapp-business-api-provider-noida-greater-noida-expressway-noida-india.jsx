...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Noida-Greater Noida Expressway, Noida, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-noida-greater-noida-expressway-noida-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Noida-Greater Noida Expressway"
    const State = "Noida"
