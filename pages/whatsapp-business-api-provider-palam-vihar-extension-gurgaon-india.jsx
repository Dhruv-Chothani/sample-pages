...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Palam Vihar Extension, Gurgaon, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-palam-vihar-extension-gurgaon-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Palam Vihar Extension"
    const State = "Gurgaon"
