...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Khirki Extension, New Delhi, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-khirki-extension-new-delhi-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Khirki Extension"
