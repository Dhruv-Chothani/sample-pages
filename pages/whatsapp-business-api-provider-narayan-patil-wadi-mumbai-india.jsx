...
// --------------------------------------------------
  ...
  const BlogPost = ({ slug, Keyword, City, State }) => {
    ...
    const fullLocation = `Narayan Patil Wadi, Mumbai, India`
...
<section className="mt-16 max-w-3xl mx-auto">
  ...
  export default function Page() {
    ...
    const slug = "whatsapp-business-api-provider-narayan-patil-wadi-mumbai-india"
    const Keyword = "WhatsApp Business API Provider"
    const City = "Narayan Patil Wadi"
    const State = "Mumbai"
